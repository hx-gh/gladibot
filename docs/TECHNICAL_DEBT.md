...
**Arquivo**: `apps/bot/src/browser.js`, `apps/bot/src/index.js`
...
**Arquivo**: `apps/bot/data/affixes.json`, `apps/bot/src/affixCatalog.js`
...
**Arquivo**: `apps/bot/src/itemCompare.js`, `consolidateMainStats`
...
**Arquivo**: `apps/bot/src/ui/server.js`, `apps/bot/src/ui/public/app.js`
...
**Arquivo**: `apps/bot/src/client.js`, `_exec`
...
**Arquivo**: `apps/bot/src/ui/public/app.js`, `analyzeRecommendation`
...
**Arquivo**: `apps/bot/src/actions/expedition.js`, `apps/bot/src/actions/dungeon.js`, `.env`, `.env.example`
